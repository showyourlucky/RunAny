...
;━━━━ 模块引入：菜单工具函数 ━━━━
#Include *i %A_ScriptDir%\lib\05_menu_util.ahk
;━━━━ 模块引入：菜单构建 ━━━━
#Include *i %A_ScriptDir%\lib\05_menu_build.ahk
;━━━━ 模块引入：菜单显示 ━━━━
#Include *i %A_ScriptDir%\lib\06_menu_display.ahk
;━━━━ 模块引入：菜单执行 ━━━━
#Include *i %A_ScriptDir%\lib\07_menu_run.ahk
;━━━━ 模块引入：菜单编辑器GUI ━━━━
#Include *i %A_ScriptDir%\lib\15_gui_menu_editor.ahk
;━━━━ 模块引入：插件管理GUI ━━━━
#Include *i %A_ScriptDir%\lib\16_gui_plugins.ahk
;━━━━ 模块引入：规则管理GUI ━━━━
#Include *i %A_ScriptDir%\lib\18_gui_runctrl_rule.ahk
;━━━━ 模块引入：设置GUI ━━━━
#Include *i %A_ScriptDir%\lib\17_gui_settings.ahk
;━━━━ 模块引入：GUI事件处理 ━━━━
#Include *i %A_ScriptDir%\lib\19_gui_events.ahk
;━━━━ 模块引入：热字符串GUI ━━━━
#Include *i %A_ScriptDir%\lib\20_hotstring.ahk
;━━━━ 模块引入：搜索功能 ━━━━
#Include *i %A_ScriptDir%\lib\08_search.ahk
;━━━━ 模块引入：通用函数方法 ━━━━
#Include *i %A_ScriptDir%\lib\04_utility.ahk
;━━━━ 模块引入：配置初始化 ━━━━
#Include *i %A_ScriptDir%\lib\09_config.ahk
;━━━━ 模块引入：图标管理 ━━━━
#Include *i %A_ScriptDir%\lib\13_icon.ahk
;━━━━ 模块引入：插件系统 ━━━━
#Include *i %A_ScriptDir%\lib\10_plugins.ahk
;━━━━ 模块引入：规则引擎 ━━━━
#Include *i %A_ScriptDir%\lib\11_runctrl.ahk
;━━━━ 模块引入：托盘+更新 ━━━━
#Include *i %A_ScriptDir%\lib\14_tray_update.ahk
;━━━━ 模块引入：Everything集成 ━━━━
#Include *i %A_ScriptDir%\lib\12_everything.ahk
;■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
